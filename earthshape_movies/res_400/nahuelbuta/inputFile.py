...
#Surface Processes
#Linear Diffusion:
linDiffBase = 3.5e-1 #m2/yr, base linear diffusivity for bare-bedrock
alphaDiff   = 0.4  #Scaling factor for vegetation-influence (see Instabulluoglu and Bras 2005)

#Fluvial Erosion:
ksp = 1e-7 #base fluvial erodibility for bare-bedrock
...
#Climate Parameters
baseRainfall = 140 #m/dt, base steady-state rainfall-mean over the dt-timespan
