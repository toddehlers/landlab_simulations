...
ncols = 400	#number of columns
nrows = 400  #number of rows
...
#Climate Parameters
baseRainfall = 0.7 #m/dt, base steady-state rainfall-mean over the dt-timespan
...
#Vegetation Cover
vp = 0.1 #initial vegetation cover, 1 = 100%
